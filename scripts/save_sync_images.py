...
class dvrk_img_save:
    def __init__(self):
        ...
        self.camera_left_topic = '/camera_dvrk/left/image_raw' # --> Add name of stereo_rig_name instead of ...
        self.camera_right_topic = '/camera_dvrk/right/image_raw' # --> Add name of stereo_rig_name instead of ...
